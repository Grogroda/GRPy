...
class Tensor:
    ...
    def __init__(self, struct, non_zeros, lista=[], coords=sp.symbols('t x y z')):
        '''
...
if __name__=="__main__":
    ...
    test=Tensor([0,0], [[0,0], [1,1], [2,2], [3,3]])
    print("Here is your test tensor:\n")
    tensor=np.array(test.lista)
    print(tensor)
